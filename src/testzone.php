...
<?php
mk_cota('cpp',<<<'EOC'
//superlooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooongline
#include<iostream>
using namespace std;
int main(){
	int a,b;cin>>a>>b;
